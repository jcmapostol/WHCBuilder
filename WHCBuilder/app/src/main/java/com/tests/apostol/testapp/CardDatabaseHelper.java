...
public class CardDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String PLANET_CHECK = " IN ('R', 'G', 'B', 'RG', 'RB', 'GB', 'RGB'))";
    ...
    private static final String TYPE_CHECK = " IN ('PL', 'WR', 'AR', 'AT', 'SU', 'EV', 'SY', 'TO'))";
    private static final String SQL_CREATE_CARD_LIST =
            "CREATE TABLE " + CardDbContract.CardListEntry.TABLE_NAME
                            ...
                            + CardDbContract.CardListEntry.COL_NAME + TEXT_TYPE + NOT_NULL + COMMA
    ...
    private static final String SQL_CREATE_WARDEFS =
            "CREATE TABLE " + CardDbContract.WarlordDefEntry.TABLE_NAME
                    + " ("
                    + CardDbContract.COL_ID + INT_TYPE + " PRIMARY KEY, "
                    + CardDbContract.WarlordDefEntry.COL_WARID + INT_TYPE + UNIQUE + NOT_NULL + COMMA
                    ...
                    + " FOREIGN KEY (" + CardDbContract.WarlordDefEntry.COL_WARID + ") REFERENCES "
                    + CardDbContract.CardListEntry.TABLE_NAME + "(" + CardDbContract.COL_ID + ")"
                    + ")";

    private static final String SQL_CREATE_PLANETDEFS =
            "CREATE TABLE " + CardDbContract.PlanetDefEntry.TABLE_NAME
                    + " ("
                    + CardDbContract.COL_ID + INT_TYPE + " PRIMARY KEY, "
                    + CardDbContract.PlanetDefEntry.COL_CARDID + INT_TYPE + UNIQUE + NOT_NULL + COMMA
                    + CardDbContract.PlanetDefEntry.COL_ICON + TEXT_TYPE + NOT_NULL + COMMA
                        + " CHECK (" + CardDbContract.PlanetDefEntry.COL_ICON + PLANET_CHECK + COMMA
                    + " FOREIGN KEY (" + CardDbContract.PlanetDefEntry.COL_CARDID + ") REFERENCES "
                    + CardDbContract.CardListEntry.TABLE_NAME + "(" + CardDbContract.COL_ID + ")"
                    + ")";
    ...
    private static final String SQL_CREATE_SQUADDEFS =
            "CREATE TABLE " + CardDbContract.SquadDefEntry.TABLE_NAME
                    ...
                    + " FOREIGN KEY (" + CardDbContract.SquadDefEntry.COL_WARID + ") REFERENCES " + CardDbContract.WarlordDefEntry.TABLE_NAME + "(" + CardDbContract.WarlordDefEntry.COL_WARID + ")"
                    + ","
...
//        db.execSQL(SQL_CREATE_PLANETDEFS);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP IF TABLE EXISTS " + CardDbContract.PlanetDefEntry.TABLE_NAME);
